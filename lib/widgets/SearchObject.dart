...
class SearchObject extends StatefulWidget {
  ...
  const SearchObject({Key? key,required this.date, required this.heure,required this.intervention}) : super(key: key);
        ...
        child: Column(
          ...
          children: [
              ...
              child: Row(
                children:  [
                  ...
                  const Padding(
                    ...
                    child: Text('à',style: TextStyle(fontFamily: 'Sfpro',color: Color.fromARGB(255, 92, 97, 105)),),
                  ),
                  Padding(
                    padding: const EdgeInsets.all(3.0),
            ...
            Padding(
              ...
              child: Text(widget.intervention,style: const TextStyle(fontFamily: 'Sfpro',fontSize: 15,),)
            ),
          ],
        ),
      ),
